...
const ja = {
  ...
  donate_amount_label: '金額を選んでください',
  donate_amount_custom: 'カスタム金額',
  donate_stripe_button: 'カードで応援する',
  donate_stripe_loading: '処理中...',
  donate_stripe_error: '決済の準備ができていません。銀行振込をご利用ください。',
  donate_stripe_generic_error: 'エラーが発生しました。もう一度お試しください。',
...
const en: Translations = {
  ...
  donate_amount_label: 'Choose an amount',
  donate_amount_custom: 'Custom amount',
  donate_stripe_button: 'Support with Card',
  donate_stripe_loading: 'Processing...',
  donate_stripe_error: 'Payment is not ready yet. Please use bank transfer.',
  donate_stripe_generic_error: 'An error occurred. Please try again.',
